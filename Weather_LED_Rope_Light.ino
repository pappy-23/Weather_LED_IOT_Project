...
String weather_cityID = "5325423";        //Azusa
...
void display_weather() {
  ...
  if(weatherAPI.id >= 800 && weatherAPI.id <= 802){ //sunny
    if(weatherAPI.temp >= 105){ //very hot
      for(int i = 0; i < 50; i++ ){
        leds[i].setRGB(255,60,0);
      }
    }
    else{
      for(int i = 0; i < 50; i++ ){
        leds[i].setRGB(255,116,7);
      }      
    }
  }

  if(weatherAPI.id != 800){ //cloudy
    if(weatherAPI.id >= 200 && weatherAPI.id <= 531){ //rainy
      if(weatherAPI.id >= 300 && weatherAPI.id <= 321){ //drizzle
        for(int i = 50; i < 116; i++ ){
          leds[i].setRGB(102,102,102);
        }
    ...
    else if(weatherAPI.id >= 600 && weatherAPI.id <= 622){ //snowy
        for(int i = 50; i < 116; i++ ){
          leds[i].setRGB(102,102,102);
        }
        for(int i = 116; i < 160; i++ ){
          leds[i].setRGB(54,139,54);
        }
    }
  ...
  if(weatherAPI.wind_speed >= 15){ //windy
    if(weatherAPI.wind_speed >= 35){ //heavy winds
